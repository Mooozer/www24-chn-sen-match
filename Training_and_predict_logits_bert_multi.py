...
CN_tokenizer = AutoTokenizer.from_pretrained(MODEL_PATH)
...
for method in methods_list:
    ...
    #save models
    output_dir = f'./bert_base_multilingual_{method}/'
    ...
    # Model (macbert_large + LW, epoch=2)   prediction and save logits
test_input_ids = []
